...
def test_install_copies_a_self_contained_runtime(tmp_path: Path) -> None:
    ...
    for relative in (
        ...
        "tools/run_state.py",
        "tools/checkpoint_keychain.py",
        "tools/checkpoint_transport.py",
        "tools/colab_checkpoint.py",
        "tools/colab_checkpoint_host.py",
        "tools/colab_drive_unmount.py",
        "tools/vm_capabilities.py",
