...
BACKEND_DEVCONTAINER_NATIVE_CAPABILITIES := image-digest environment host-requirements forward-ports security-policy
BACKEND_DEVCONTAINER_REALIZATION_ORDER := native
