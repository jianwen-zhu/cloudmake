...
BACKEND_CAPABILITIES := sync execute status incremental-sync shell artifacts gpu cancel persistent-storage native-persistence oci-runner devcontainer port-forward
...
BACKEND_CONTEXT_RESOURCE_LABEL := studio
BACKEND_CONTEXT_RESOURCE := $(LIGHTNING_STUDIO)
BACKEND_CONTEXT_ACCELERATOR := $(LIGHTNING_MACHINE)
