...
[backend contract](docs/reference/backend-contract.md#internal-engine-dispatch).

Durable contract decisions and remaining open items are tracked in
[Design decisions](design/decisions.md). Release review must close each required
item with tests or explicitly defer it to a named later release.
